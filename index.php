<?php  
// INSERT INTO `notes` (`sno`, `tittle`, `description`, `tstamp`) VALUES (NULL, 'But Books', 'Please buy books from Store', current_timestamp());
$insert = false;
$update = false;
$delete = false;
...
if (isset( $_POST['snoEdit'])){
  ...
  $sql = "UPDATE `notes` SET `tittle` = '$tittle' , `description` = '$description' WHERE `notes`.`sno` = $sno";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
